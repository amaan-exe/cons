                        ...
                        <div className="bg-gradient-primary rounded-2xl p-8 shadow-lg text-white">
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <span className="font-semibold">+91 9308760389</span>
                                </a>
<a
                                ...
                                >
                                    ...
                                    <span className="font-semibold">+91 8409640040</span>
                                </a>
                                <a
                ...
                <motion.div
                    ...
                    className="mt-12"
                >
                    <h3 className="font-heading font-bold text-2xl text-secondary-900 mb-6 text-center">
                        Find Us Here
                    </h3>
                    <LocationMap />
                </motion.div>
